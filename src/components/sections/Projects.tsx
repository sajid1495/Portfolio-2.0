...
const projects = [
  ...
  {
    title: 'Portfolio 2.0',
    description: 'A modern, responsive personal portfolio website built with Next.js 14 and TypeScript. Features dark/light theme toggle, smooth scroll animations, and sections for skills, projects, education, and contact. Deployed on Netlify with optimized performance.',
    image: null,
  ...
  {
    title: 'myCash',
    description: 'A simple terminal program simulating a Mobile Financial Service. Features include user registration, login, account management, send money, cash in/out, bill payment, balance check, transaction history, and statements. Built as a foundational version with exciting updates planned.',
    image: null,
  ...
  },
  {
    ...
    description: 'An unfinished academic web app project featuring a modern frontend built with Next.js and TypeScript. Includes Prisma for database management and a structured architecture for school management functionality. Development was terminated after completing the frontend.',
    image: null,
